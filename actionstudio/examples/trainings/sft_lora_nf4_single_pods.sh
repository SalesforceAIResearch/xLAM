...
WANDB_RUN_NAME="sft_lora_fc_${FC_MODE}_${PRECISION}_ds_${DS_STAGE}_sq_${SEQ_LEN}_bs_${BATCH_SIZE}_lr_${LEARNING_RATE}_ga_${GRADIENT_ACCUM_STEPS}__${MODEL_SAVE_ID}" 
